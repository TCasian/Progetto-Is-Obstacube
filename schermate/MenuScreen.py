...
from schermate.ImpostazioniScreen import *
...
class MenuScreen(arcade.View):
    ...
    def _configura_stato(self):
        ...
        if self.state == self.INTRO:
            ...
            self.fadeManager.start_fade((0, 0, 0, 255), (255, 255, 255, 255))  # Fade da nero a trasparente
            self.draw_state = self._draw_intro
        elif self.state == self.BUTTONS:
            sleep(1)  # Piccola pausa prima del fade
            self.fadeManager.start_fade((255, 255, 255, 255), (173, 216, 230, 25))  # Fade da bianco a trasparente
            arcade.set_background_color(arcade.color.LIGHT_BLUE)
         # Crea i bottoni nello stato BUTTONS
    ...
    def on_draw(self):
        ...
        self.draw_state()
        self.ui_manager.draw()  # Disegna i bottoni
